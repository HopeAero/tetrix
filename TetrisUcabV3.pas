...
type
 ...
 const
   ubicacion = ('Jugadores.dat'); {ubicacion del archivo}
   pared = 9;
    ...
    case n of  // figura escogidas por el usuario
     ...
     2:begin
      ...
      begin
          ...
          Dibujar(x,y+1);
          Dibujar(x,y-1);
          Dibujar(x-1,y-1);       // Plantilla de forma 4
          //     []
          //     []
          //   [][]
      end;
      ...
      begin
        ...
        Dibujar(x,y+1);
        Dibujar(x+1,y+1);
        Dibujar(x,y-1);     // Plantilla de forma 5
        //   [][]
        //   []
        //   []
      end;
      ...
      begin
        ...
        Dibujar(x,y+1);
        Dibujar(x,y-1);
        Dibujar(x-1,y+1);      // Plantilla de forma 6
        //   [][]
        //     []
        //     []
      end;
      ...
      Dibujar(x-1,y);
      Dibujar(x+1,y);
       Dibujar(x,y-2); // Plantilla de forma 7
      //   [][][]
      //     []
      //     []
      ...
      begin
        ...
        Dibujar(x-1,y);
        Dibujar(x,y+1);
         Dibujar(x,y+2);   // Plantilla de forma 8
...
begin
  Repeat
    ...
    repeat // ¡Empieza a repetir el bucle principal del juego! Siempre que haya un espacio vacío en el campo para el movimiento y la aparición de nuevas piezas.
      ...
      until Tope_Matriz = 1; // ¡Deja de repetir el ciclo principal del juego! Porque no hay espacio vacío.
       ...
       begin
         ...
         begin
            begin
             if jugar=true then
              begin
              writeln('USTED NO HA INICIADO SESION PULSE [ENTER]');
              readln;
              menu;
              end;
            end;
         end;
      until (jugar=false) or (eleccion=2);
