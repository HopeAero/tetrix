...
begin
     ...
     for i:=1 to length(cadena) do
         if ord(cadena[i]) in[32,65..90,97..122,164,165] then
         begin
         // verificacion de letras introducidas
         end
           else
              valido := false;
     ...
     begin
       ...
       writeln(' Nombre               Numero          Estado');
         For M:=1 to 5 do
          ...
          gotoxy(25,4 + M);write(orden[M].ID);
          gotoxy(38,4 + M);write(orden[M].alias);
          gotoxy(50,4 + M);write(orden[m].Score);
          end;
         end;
       readln;
     end;
